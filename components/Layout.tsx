      ...
      <div className="hidden md:flex w-64 bg-ecomattBlack text-white flex-col h-screen sticky top-0 z-30">
        ...
        <div className="p-6 flex items-center gap-3 border-b border-gray-800">
            ...
            <div>
                ...
                <p className="text-[10px] text-ecomattBlack font-bold uppercase tracking-widest bg-ecomattGreen px-2 py-0.5 rounded mt-1 inline-block">v5.5 (Final Fix)</p>
            </div>
        </div>
        ...
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 md:px-8 shrink-0 z-20">
           ...
           <div className="flex items-center gap-3 md:hidden">
              ...
              <div>
                  ...
                  <p className="text-[9px] text-ecomattGreen font-bold">v5.5</p>
              </div>
           </div>
